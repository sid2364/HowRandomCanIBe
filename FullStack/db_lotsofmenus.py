...
print "Added menu items from ud088!\nUpdating price of veggie burger!"
...
UrbanVeggieBurger = session.query(MenuItem).filter_by(id=8).one() # for a specific restaurant with id=8
